...
script you can click on the icon that looks like a page with a â€˜+â€™
underneath File and select â€“&gt;R script. This generates a `.R` file.
...
And now weâ€™re ready to start the fun part!
