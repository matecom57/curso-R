...
-   Go to `RStudio download <https://posit.co/download/rstudio-desktop/#download>`_ page and install the version that is
    compatible with your operating system.
    This `link <https://datacarpentry.github.io/R-ecology-lesson/>`_ provides
