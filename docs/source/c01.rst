...
Instalación en su propia computadora
------------------------------------

Para usar RStudio en su computadora, puede descargar R y RStudio. Si no tiene R y RStudio instalados:
